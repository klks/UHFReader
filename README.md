...
## Supported Readers (HID)
1. COMPRO T5-AU-00-00  - To be done in the near future

## Building
1. Built with Visual Studio 2026

## Contributing
1. Fork and create a feature branch.
1. Add tests for new behavior.
1. Ensure lint / type checks pass.
1. Submit a concise pull request description.