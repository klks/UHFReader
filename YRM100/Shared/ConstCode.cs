...
public class ConstCode
{
    ...
    /// </summary>
    //public const string FRAME_BEGIN_HEX = "AA";       //YPD-R200
    //public const string FRAME_BEGIN_HEX = "BB";       //YRM-100

    /// <summary>
    /// Packet End Hex String
    /// </summary>
    //public const string FRAME_END_HEX = "DD";         //YPD-R200
    //public const string FRAME_END_HEX = "7E";         //YRM-100

    /// <summary>
    /// Packet Begin Byte
    /// </summary>
    //public const byte FRAME_BEGIN_BYTE = 170;         //YPD-R200
    //public const byte FRAME_BEGIN_BYTE = 187;         //YRM-100

    /// <summary>
    /// Packet End Byte
    /// </summary>
    //public const byte FRAME_END_BYTE = 221;           //YPD-R200
    //public const byte FRAME_END_BYTE = 126;           //YRM-100
    ...
    /// </summary>
    public const string CMD_SET_SWITCH_ANT = "A8";

    /// <summary>
    /// Command Type : Get Reader Switch Ant
    /// </summary>
    public const string CMD_GET_SWITCH_ANT = "A7";
